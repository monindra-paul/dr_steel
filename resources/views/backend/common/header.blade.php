...
<head>
  ...
  <!-- Favicons -->
  <link href="{{('assets/img/drsteel/logo/drsteel-logo.png')}}" rel="icon">
  <link href="{{('assets/img/drsteel/logo/drsteel-logo.png')}}" rel="apple-touch-icon">
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.html" class="logo d-flex align-items-center">
        <img src="{{('assets/img/drsteel/logo/drsteel-logo.png')}}" alt="">
        <span class="d-none d-lg-block">DR Steel</span>
      </a>
